...
export default function Calendar() {
  ...
  const handleEditTask = async (taskData: any) => {
    try {
      ...
      // Transform the task data to match the API schema
      const transformedTaskData = {
        ...taskData,
        startDate: taskData.startDate.toISOString(),
        deadline: taskData.deadline?.toISOString(),
        tags: taskData.tags, // Already in the correct format (array of strings)
      };

      console.log('Sending update data:', transformedTaskData);
